...
import controller.fruitHelper;
import model.fruit;

public class StartProgram {

		static Scanner in = new Scanner(System.in);
		static fruitHelper lih = new fruitHelper();
		...
		private static void addAnItem() {
			...
			fruit toAdd = new fruit(store, item);
		...
		private static void deleteAnItem() {
			...
			fruit toDelete = new fruit(store,item);
		...
		private static void editAnItem() {
			...
			if (!foundItems.isEmpty()) {
				...
				for (fruit l : foundItems) {
					System.out.println(l.getId() + " : " + l.toString());
				}
				System.out.print("Which ID to edit: ");
				int idToEdit = in.nextInt();

				fruit toEdit = lih.searchForItemById(idToEdit);
		...
		private static void viewTheList() {
			// TODO Auto-generated method stub
			List<fruit> allItems = lih.showAllItems();
			for(fruit singleItem : allItems) {
